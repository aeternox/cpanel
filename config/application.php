...
return array(
	'ServerAddress'				=> $AETERNOX_SERVER,				// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	...
	'InstallerPassword'			=> $AETERNOX_PASSWORD,		// Installer/updater password.
	...
	'DateDefaultTimezone'		=> 'Asia/Singapore',					// The default timezone, consult the PHP manual for valid timezones: http://php.net/timezones (null for defaut system TZ)
	...
	'RequireEmailConfirm'		=> $AETERNOX_EMAIL_CONFIRM,					// Require e-mail confirmation during registration.
	'RequireChangeConfirm'		=> $AETERNOX_EMAIL_CONFIRM,					// Require confirmation when changing e-mail addresses.
	'EmailConfirmExpire'		=> 24,						// E-mail confirmations expire hours. Unconfirmed accounts will expire after this period of time.
	...
	'MailerFromAddress'			=> $AETERNOX_EMAIL,		// The e-mail address displayed in the From field.
	'MailerFromName'			=> 'Aeternox',			// The name displayed with the From e-mail address.
	...
	'MailerSMTPPort'			=> $AETERNOX_SMTP_PORT,					// When MailerUseSMTP is true: SMTP server port (mailer will default to 25).
	'MailerSMTPHosts'			=> $AETERNOX_SMTP_HOST,					// When MailerUseSMTP is true: A string host or array of hosts (e.g., 'host1' or array('host1', 'backuphost')).
	'MailerSMTPUsername'		=> $AETERNOX_EMAIL,					// When MailerUseSMTP is true: Authorized username for SMTP server.
	'MailerSMTPPassword'		=> $AETERNOX_SMTP_PASSWORD,					// When MailerUseSMTP is true: Authorized password for SMTP server (for above user).
	...
	'DisplayCashPoints'			=> true,					// Whether or not to display "Cash Points" instead of the player's "Credits" in the control panel.
	'CreditExchangeRate'		=> 0.01,						// The rate at which credits are exchanged for dollars.
...
// Discord Webhooks
	...
	'TinyMCEKey'				=> $AETERNOX_TINY_MCE_API_KEY,				// Register for a key at https://www.tiny.cloud/my-account/dashboard/
